...
export default {
  ...
  methods: {
    ...
    unlike() {
      ...
      this.addUnlikeToPost(cloneDeep(unlikePayload))
      this.addUnlikeLogToUser(cloneDeep(unlikePayload))
    },
    ...mapActions(['addLikeLogToUser', 'addUnlikeLogToUser']),
    ...mapActions('posts', ['addLikeToPost', 'addUnlikeToPost'])
  },
  filters: {
    time(val) {
